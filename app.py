...
def start_scheduled_tasks():
    ...
    scheduler.add_job(update_room_availability2, 'interval', days=1, start_date='2024-12-10 01:48:00')
    scheduler.add_job(update_reservations2, 'interval', days=1, start_date='2024-12-10 01:48:00')
    scheduler.start()
